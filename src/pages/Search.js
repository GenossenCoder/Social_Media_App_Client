...
const Search = () => {
    ...
    const {data, loading} =useQuery(FETCH_SEARCH,{variables:{filter: filter}})

  return (
    <div className="">
        <Navbar/>
        <div className="flex justify-center mt-40">
            <input onChange={(e)=>{setFilter(e.target.value.trim())}} className=" w-1/3 bg-white/50 border-b-2 border-sky-400 p-4 text-xl rounded-xs outline-none" placeholder="Search..."/>
        </div>
        <div className="flex justify-center">
            ...
            {data&&
            <div className="flex justify-center bg-white/25 flex-col gap-2 my-10 w-1/3">
