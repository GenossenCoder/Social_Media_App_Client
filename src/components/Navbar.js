      ...
      return(
        <div className="bg-white shadow-xl flex flex-row fixed w-full top-0">
          ...
          <ul className="basis-1/2 flex flex-row items-center">
              ...
              <Link to={`/login`}><li className="basis-1/4 p-8 cursor-pointer flex items-center justify-center border-b-2 text-2xl border-white hover:border-emerald-300 hover:text-emerald-300 hover:animate-pulse">Logout</li></Link>
          </ul>
      </div>
      )
    }
      ...
      return (
        ...
        <div className="flex-1 flex justify-end items-center">
          ...
          <ul className="bg-white absolute translate-y-1.5 translate-x-full right-0 w-64 flex flex-col border-2 border-white border-t-0 rounded-t-none rounded-l-md text-xl group-hover:translate-x-0 transition-all duration-700">
            ...
            <Link to={`/login`}><li className="hover:border-emerald-300 w-full flex justify-center p-5 border-b-2 border-white text-2xl">Logout</li></Link>
          </ul>
          </div>
          </div>
    </div>
